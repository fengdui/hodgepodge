package com.fengdui.framework.image;
...
public class ImageMarkLogoByIcon {
     ...
     * @param widthPercent  水印图片x坐标位于原图片宽度的百分比0~1
     * @param heightPercent 水印图片y坐标位于原图片高度的百分比0~1
     * @param zoomPercent   水印图片的缩放比例0~1
     */
